export const QUOTES = [
  ...
  [
    'Both good and bad days should end with productivity. You mood affairs should never influence your work.',
    'Greg Evans'
  ],
  [
  ...
  ['Winners Take All', '"Quiet Riot" song'],
  [
  ...
  [
    '	Would you like to give you a formula for success? It’s quite simple, really. Double your rate of failure.',
    'Thomas J. Watson'
  ],
  ...
  ['Hard work and commitment separates the winners from losers.', 'MJ DeMarco'],
  [
